...
class RobertaEMOModel(FairseqLanguageModel):
    ...
    def __init__(self, args, encoder):
        ...
        #list_of_models = list_of_models =['./trained_models/wav2vec/wav2vec_large.pt'] #MODIFIED
        list_of_models = list_of_models =['/home/kdeboer/sseft/pre-trained_models/wav2vec_large.pt']
        ...
        list_of_models =  ['/home/kdeboer/sseft/pre-trained_models/affectnet_4views.pth'] #MODIFIED
